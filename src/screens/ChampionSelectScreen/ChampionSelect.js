...
const ChampionSelectScreen = ({ route, navigation }) => {
  ...
  const [championsList, setChampionsList] = useState(() => {
    return route.params.championNames
  }
  // "Aatrox",
  // "Ahri",
  // "Akali",
    ...
    return(
        <View style={styles.container}>
          ...
          >
            ...
            return(
              <View key={key}>
                <TouchableOpacity style={styles.championTouchable} key={key} onPress={() => navigation.navigate('Main', {selectedChampion: championsList[key]})}>
                <Image
